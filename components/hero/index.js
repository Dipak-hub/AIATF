          ...
          >
            <div className="container">
              ...
              <div className="slide-title">
                <h2>Discover the heart of the global textile </h2>
              </div>
              <div data-swiper-parallax="400" className="slide-text">
                <p>
                  Discover the heart of the global textile and apparel industry
                  at the Ashgree International Apparel and Textile Fair. As a
                  leading platform for industry leaders, designers,
                  manufacturers, and buyers, this event is your gateway to the
                  latest trends, innovations, and opportunities in textiles and
                  fashion.
                </p>
              </div>
